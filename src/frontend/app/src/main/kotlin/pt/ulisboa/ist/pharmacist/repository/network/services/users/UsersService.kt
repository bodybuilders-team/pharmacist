package pt.ulisboa.ist.pharmacist.repository.network.services.users
...
import pt.ulisboa.ist.pharmacist.repository.network.services.users.models.login.LoginOutput
import pt.ulisboa.ist.pharmacist.repository.network.services.users.models.register.RegisterInput
import pt.ulisboa.ist.pharmacist.repository.network.services.users.models.register.RegisterOutput
...
class UsersService @Inject constructor(
    ...
    suspend fun login(
        ...
        post(
            ...
            body = pt.ulisboa.ist.pharmacist.repository.network.services.users.models.login.LoginInput(
                username,
                password
            )
        )
