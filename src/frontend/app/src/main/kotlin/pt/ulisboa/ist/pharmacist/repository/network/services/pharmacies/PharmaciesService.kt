package pt.ulisboa.ist.pharmacist.repository.network.services.pharmacies
...
import pt.ulisboa.ist.pharmacist.repository.network.services.pharmacies.models.addPharmacy.AddPharmacyOutputModel
import pt.ulisboa.ist.pharmacist.repository.network.services.pharmacies.models.changeMedicineStock.ChangeMedicineStockModel
...
import pt.ulisboa.ist.pharmacist.repository.network.services.pharmacies.models.getPharmacies.GetPharmaciesOutputModel
import pt.ulisboa.ist.pharmacist.repository.network.services.pharmacies.models.getPharmacyById.PharmacyWithUserDataModel
import pt.ulisboa.ist.pharmacist.repository.network.services.pharmacies.models.listAvailableMedicines.ListAvailableMedicinesOutputModel
 ...
 */
class PharmaciesService @Inject constructor(
    context: Context,
    ...
    suspend fun listAllAvailableMedicines(
        ...
        var offset = 0L
        val allMedicines =
            mutableListOf<pt.ulisboa.ist.pharmacist.repository.network.services.pharmacies.models.listAvailableMedicines.MedicineStockModel>()
